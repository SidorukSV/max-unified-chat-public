...
Процедура ЗаполнитьЗначенияКонстанты()
	...
	ЗначенияКонстант = РегистрыСведений.бит_омни_ЗначенияНастроек.ЗначенияВсехКонстант();
...
Функция СохранитьЗначенияСервер()
	...
	РегистрыСведений.бит_омни_ЗначенияНастроек.УстановитьЗначенияКонстантыСРазрезом(
		ДанныеКонстанты.Константа,
