...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Справочники.бит_омни_Настройки.АктуализироватьКонстанты();
...
Процедура КонстантаНажатие(Элемент, СтандартнаяОбработка)
	...
	Иначе
		...
		ОткрытьФорму(
			"РегистрСведений.бит_омни_ЗначенияНастроек.Форма.ФормаВводаЗначенийПоРазрезу",
			ПараметрыОткрытия,
			ЭтотОбъект,
			, // Уникальность
			, // Окно
...
Процедура СоздатьРеквизитыТаблицФормы()
	...
	ТипЗначения = Метаданные.РегистрыСведений.бит_омни_ЗначенияНастроек.Ресурсы.Значение.Тип;
	ТипРазреза = Метаданные.РегистрыСведений.бит_омни_ЗначенияНастроек.Измерения.Разрез.Тип;
...
Процедура ЗаполнитьТаблицыКонстант()
	...
	ТаблицаЗначенийКонстантБД = РегистрыСведений.бит_омни_ЗначенияНастроек.ЗначенияВсехКонстант();
	ТаблицаОписанияКонстант = бит_омни_ОбщегоНазначенияПолныеПрава.ТаблицаОписанияКонстант();
	ТаблицаКонстантБД = Справочники.бит_омни_Настройки.ТаблицаКонстантБД(Истина);
...
Процедура ЗаполнитьТаблицуГруппКонстант()
	...
	ПредставленияГруппКонстант = Справочники.бит_омни_Настройки.ПредставленияГруппКонстант();
	...
	Для каждого ДанныеКонстанты Из ДанныеКонстант Цикл
		...
		Если ЭтоКонстантаБезРазреза(ДанныеКонстанты) Тогда	
			...
			Иначе
				...
				ЭлементФормыКонстанта.ПараметрыВыбора = ДанныеКонстанты.ПараметрыВыбора;
...
Процедура УстановитьЗначениеКонстантыБезРазреза(Идентификатор)
	...
	РегистрыСведений.бит_омни_ЗначенияНастроек.УстановитьЗначениеКонстантыБезРазреза(
